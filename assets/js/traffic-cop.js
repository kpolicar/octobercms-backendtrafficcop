var initializedKey = 'kpolicar_backendtrafficcop_initialized';

if ($('html').data(initializedKey) !== true) {
    ...
    $(document).on('ajaxSetup', function (event, context) {
        if (context.handler === 'onSave') {
            context.options.update = $.extend(context.options.update, {
